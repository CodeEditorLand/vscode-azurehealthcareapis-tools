...
See relevant service documentation for using the templates in data conversion
process:
...
If a converter workspace is already opened and you want to switch to another
